...
namespace Synthora.Controls
{
    ...
    public class HeaderPresenter : ContentControl
    {
        ...
        protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
        {
            ...
            UpdateTemplatedParent(TemplatedParent as Control);
        }
        ...
        protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
        {
            ...
            {
                UpdateTemplatedParent(change.NewValue as Control);
            }
        ...
        private void UpdateTemplatedParent(Control? templatedParent)
        {
        ...
        private void UpdateIsVisible() => SetCurrentValue(IsVisibleProperty, Content is not null);
    }
}