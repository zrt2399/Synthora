...
namespace Synthora.Controls
{
    ...
    public enum WrapPanelItemsAlignment
    {
        ...
        /// </summary>
        /// <remarks>
        /// <see cref="SpacingWrapPanel.ItemSpacing"/> becomes the minimum spacing between items.
        /// </remarks>
        Justify,
        ...
        /// </summary>
        /// <remarks>
        /// <see cref="SpacingWrapPanel.ItemWidth"/> or <see cref="SpacingWrapPanel.ItemHeight"/> becomes the minimum size of items.
        /// </remarks>
        Stretch,
    ...
    public class SpacingWrapPanel : Panel, INavigableContainer
    {
        ...
        public static readonly StyledProperty<double> ItemSpacingProperty =
            AvaloniaProperty.Register<SpacingWrapPanel, double>(nameof(ItemSpacing));

        /// <summary>
        /// Defines the <see cref="LineSpacing"/> property.
        /// </summary>
        public static readonly StyledProperty<double> LineSpacingProperty =
            AvaloniaProperty.Register<SpacingWrapPanel, double>(nameof(LineSpacing));

        /// <summary>
        /// Defines the <see cref="Orientation"/> property.
        /// </summary>
        public static readonly StyledProperty<Orientation> OrientationProperty =
            AvaloniaProperty.Register<SpacingWrapPanel, Orientation>(nameof(Orientation), defaultValue: Orientation.Horizontal);
        ...
        public static readonly StyledProperty<WrapPanelItemsAlignment> ItemsAlignmentProperty =
            AvaloniaProperty.Register<SpacingWrapPanel, WrapPanelItemsAlignment>(nameof(ItemsAlignment), defaultValue: WrapPanelItemsAlignment.Start);

        /// <summary>
        /// Defines the <see cref="ItemWidth"/> property.
        /// </summary>
        public static readonly StyledProperty<double> ItemWidthProperty =
            AvaloniaProperty.Register<SpacingWrapPanel, double>(nameof(ItemWidth), double.NaN);

        /// <summary>
        /// Defines the <see cref="ItemHeight"/> property.
        /// </summary>
        public static readonly StyledProperty<double> ItemHeightProperty =
            AvaloniaProperty.Register<SpacingWrapPanel, double>(nameof(ItemHeight), double.NaN);

        /// <summary>
        /// Initializes static members of the <see cref="SpacingWrapPanel"/> class.
        /// </summary>
        static SpacingWrapPanel()
        {
            AffectsMeasure<SpacingWrapPanel>(ItemSpacingProperty, LineSpacingProperty, OrientationProperty, ItemWidthProperty, ItemHeightProperty);
            AffectsArrange<SpacingWrapPanel>(ItemsAlignmentProperty);
        }
        ...
        /// <summary>
        /// Gets or sets the alignment of items in the <see cref="SpacingWrapPanel"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the width of all items in the <see cref="SpacingWrapPanel"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the height of all items in the <see cref="SpacingWrapPanel"/>.
        /// </summary>
